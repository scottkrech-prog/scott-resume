...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-[#171923]" sectionId={SectionId.Contact}>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-300 hover:text-[#2878f1] focus:outline-none focus:ring-2 focus:ring-[#2878f1]',
